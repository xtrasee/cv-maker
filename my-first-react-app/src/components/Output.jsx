...
export default function Output({ info, education, experience }) {

  return (
    <Default info={info} education={education} experience={experience}/>
  )

  function Default({ info, education, experience }) {
